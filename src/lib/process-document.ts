...
import { chunkTextWithSections } from "@/lib/chunk";
...
export const processDocument = async (
  ...
  try {
    ...
    const rows = chunks.map((chunk, idx) => ({
      ...
      metadata: chunk.sectionPath.length ? { section_path: chunk.sectionPath } : {},
    }));
